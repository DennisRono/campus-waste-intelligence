...
* [x] Generate additional synthetic observations
  * [x] Add location types - SECTION A, B, C, D
* [x] Preserve temporal structure of original data
...
* [x] Determine temporal resolution (e.g., daily, hourly) - 30min
* [x] Confirm target variable - waste weight
* [x] Ensure alignment with cleaned and augmented dataset
...
* [ ] Conduct review with team
  * [ ] Nicholas (contamination model integration)
  * [ ] Sarthak (decision-making layer integration)
